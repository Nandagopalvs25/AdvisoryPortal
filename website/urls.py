...
from .views import index,dashboard,certificates,mooc,internship,extrac,workshops,student_uploads_view,studentsList,deleteMooc,deleteExtrac,deleteWorkshops,deleteIntern,advisor_approval_view
